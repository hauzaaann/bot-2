...
const { lirikCommand } = require("./commands/lirik");
    ...
    try {
        ...
        if (isBanned(senderId) && !userMessage.startsWith(".unban")) {
            ...
            if (Math.random() < 0.1) {
                await sock.sendMessage(chatId, {
                    text: "❌ Kamu diblokir dari penggunaan bot ini. Hubungi admin untuk mengajukan pembukaan blokir.",
                });
            }
            return;
        }
        ...
        switch (true) {
            ...
            case userMessage.startsWith(".8ball"):
                ...
                break;
            case userMessage.startsWith(".lirik"):
                const songTitle = userMessage.split(" ").slice(1).join(" ");
                await lirikCommand(sock, chatId, songTitle);
                break;
            ...
            case userMessage.startsWith(".play") ||
                ...
                await songssssCommand(sock, chatId, message);
                break;
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === "add") {
            ...
            const data = JSON.parse(
                fs.readFileSync("./data/userGroupData.json"),
            );
